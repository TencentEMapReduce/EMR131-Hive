...
public final class FunctionRegistry {
  ...
  static {
    // 自定义函数
    system.registerFunction("add_date", UDFAddDate.class);
    system.registerFunction("to_char", UDFToChar.class);
    system.registerFunction("sysdate", UDFSysDate.class);
    system.registerFunction("to_pinyin", UDFHanyuToPinyin.class);
    system.registerFunction("str_to_date", UDFStrToDate.class);
    system.registerFunction("url_decode",UDFUrlDecode.class);
    system.registerGenericUDF("za_row_number", GenericUDFRowNumber.class);
    system.registerGenericUDF("za_lag", org.apache.hadoop.hive.ql.udf.zhenai.GenericUDFLag.class);
    system.registerGenericUDF("za_date_add", GenericUDFZADateAdd.class);
    system.registerFunction("dayofweek", UDFDayOfWeek.class);
